...
import io.adappt.contact.ContactContract
import io.adappt.contact.ContactContract.Companion.CONTACT_CONTRACT_ID
...
object CreateContactFlow {
    ...
    @InitiatingFlow
    @StartableByRPC
    class Initiator(val contactId: String,
        ...
        override fun call(): SignedTransaction {
            ...
            val contactState = Contact(contactId, firstName, lastName, email, phone, serviceHub.myInfo.legalIdentities.first())
